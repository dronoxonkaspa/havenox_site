...
export default function FAQ() {
  const faqs = [
    {
      question: "How does HavenOx escrow work?",
      answer:
    ...
    },
    {
      ...
      answer:
        "HavenOx charges a 2% platform fee on every completed trade and a 10 KAS non-refundable listing fee for posting on the marketplace. These fees keep the platform secure and sustainable.",
    },
    {
    ...
    {
      question: "Is HavenOx decentralized?",
      answer:
        "Yes. HavenOx uses decentralized storage, blockchain verification, and open APIs to maintain transparency. Escrow confirmations require both parties’ signatures for safety.",
    },
  ];
